...
simbolo electrico tipico mida ~target_px en la imagen renderizada.
...
Requiere: pip install ezdxf numpy
"""
...
# Tamanos objetivo en pixeles. Para SIFT conviene mas grande (100-200) que
# para YOLO (~64), porque SIFT necesita textura interna para sacar keypoints.
...
def calcular_factor_escala(dxf_path, target_px=TAMANO_SIMBOLO_OBJETIVO_PX):
    ...
    target_px: tamano en pixeles que queres que tenga un simbolo tipico
               en la imagen rasterizada. Para SIFT recomiendo 100-200.
    """
