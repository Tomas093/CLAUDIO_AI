...
N_SPRITE_VARIATIONS = 150    # Número de variaciones de grosor de línea
DILATION_KERNEL_MIN = 2     # Kernel mínimo (línea delgada, sin cambio)
DILATION_KERNEL_MAX = 150    # Kernel máximo (línea gruesa)
...
N_SYNTHETIC_TOTAL      = 10000  # Total de imágenes sintéticas a generar
...
COMPONENTS_PER_IMG_MAX = 5    # Máximo de componentes por imagen
